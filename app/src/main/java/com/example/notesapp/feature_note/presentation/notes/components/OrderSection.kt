...
fun OrderSection(
    ...
    Column(modifier = modifier) {
        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            DefaultRadioButton(
                text = "Ascending",
                selected = noteOrder.orderType is NoteOrderType.Ascending,
                onSelect = { onOrderChange(noteOrder.copy(NoteOrderType.Ascending)) },
                modifier = modifier
            )
            ...
            DefaultRadioButton(
                text = "Descending",
                selected = noteOrder.orderType is NoteOrderType.Descending,
                onSelect = { onOrderChange(noteOrder.copy(NoteOrderType.Descending)) },
                modifier = modifier
            )
