...
import com.example.notesapp.feature_note.presentation.notes.components.NotesScreen
            ...
            NotesAppTheme {
                ...
                Surface(
                    ...
                    NavHost(navController = navController, startDestination = Screen.NotesScreen.route){
                        ...
                        composable(route = Screen.AddEditScreen
                            .route + "?noteId={noteId}&noteColor={noteColor}",
                        arguments = listOf(
